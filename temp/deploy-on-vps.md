...
- You need to Install git,ffmpeg,curl,nodejs,yarn with pm2 
   ...
   5. Clone Repo and install required packages
      ```
      git clone https://github.com/Eliahhango/Elitechwiz-Md
      cd Elitechwiz-Md
   ...
   6. Create an env file for ENV. 
      ...
      ```
      OWNER_NUMBER="255688164510"
      SESSION_ID = "SESSION_85_23_59_01_kjgfgfclhj"
      THUMB_IMAGE = "https://mallucampaign.in/images/img_1714767949.jpg"
      OWNER_NAME = "Elitechwiz"
      PREFIX = .
      WARN_COUNT = 3
      DISABLE_PM = "false"
      THEME= "ELITECHWIZ"
