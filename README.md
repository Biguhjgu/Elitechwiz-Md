 <h1 align="center"> Elitechwiz Md </h1> 
...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://Elitechwiz-md-vtsf.onrender.com/) Or [`PARING CODE`](https://suhail-md-vtsf.onrender.com/code). Then `Go-to Whatapp>Three dots>Linked Devices`***
